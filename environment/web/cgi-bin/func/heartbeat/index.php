...
class HeartBeatLauncher extends CommonLauncher
{
    // エントリーポイント
    public function run()
    {
...
LAUNCHER_END:
    ...
    {
        $this->_m_WORK_IN_FILE = 'input_HeartBeat.json';
        $this->_m_WORK_OUT_FILE = 'output_HeartBeat.json';
        ...
        case 'GET':
            ...
            break;
        case 'POST':
            $_REQUEST['X_CMD_ARGS'] = "-postheartbeat ";
            break;
        default:
            $_REQUEST['X_CMD_ARGS'] = "-getheartbeat ";
        }
